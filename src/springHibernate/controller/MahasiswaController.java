...
public class MahasiswaController {
    ...
    private MahasiswaTableModel mahasiswaTabelModel;
...
//        mahasiswaTabelModel = new MahasiswaTableModel(mahasiswas);
//        this.mahasiswaView.getTabel().setModel(mahasiswaTabelModel);
    }
